<?php
/**
 * MILLETS.PHP – EXACT CLONE OF rice.php UI + LOGIC
 * --------------------------------------------------
 ...
 * ✔ ONLY millets products
 * ✔ Variety filter auto-generated from DB
 */
...
/* =========================================================
   AUTO REDIRECT: /products?category=millets → /millets
========================================================= */
if (isset($_GET['category']) && $_GET['category'] === 'millets') {
  header("Location: /IndusAgrii/public/millets.php", true, 301);
  exit;
}
...
/* =========================================================
   PAGE META
========================================================= */
$pageTitle = "Millets Collection | Indus Agrii";
$pageDescription = "Premium Indian millets sourced directly from farms.";

/* =========================================================
   PAGINATION (SAME AS rice.php)
========================================================= */
$limit = 9;

/* =========================================================
   ADD TO CART – IDENTICAL TO rice.php
========================================================= */
...
/* =========================================================
   AJAX FILTER / SEARCH / SORT (CLONED FROM rice.php)
   DIFFERENCE: category LOCKED TO millets
========================================================= */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax'])) {
  ...
  while ($product = $products->fetch_assoc()):
    if ($product['category'] !== 'millets') continue; // 🔒 HARD BLOCK
...
<div
  class="product-card group cursor-pointer border border-gray-200 rounded-2xl bg-white overflow-hidden flex flex-col w-full transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:border-emerald-300"
...
<img
  ...
  class="w-full h-full object-cover
         ...
         <?= !$product['in_stock'] ? 'grayscale opacity-80' : 'group-hover:scale-105' ?>">
 </div>
  ...
  <div class="p-3 flex flex-col gap-2">
    ...
    <div class="flex gap-2">
      ...
      <div class="flex-1 h-9 flex items-center justify-between border rounded-lg px-2">
        <button type="button" class="qty-minus text-sm leading-none">−</button>
        <input type="number" value="1" min="1" class="qty-input w-8 text-center text-xs outline-none">
        <button type="button" class="qty-plus text-sm leading-none">+</button>
      </div>
    </div>
...
========================================================= */
$varieties = [];
$vRes = $conn->query("SELECT DISTINCT variety FROM products WHERE category = 'millets' AND variety IS NOT NULL AND variety != ''");
while ($v = $vRes->fetch_assoc()) {
  $varieties[] = $v['variety'];
}
$bodyClass = "millets-page";

include __DIR__ . "/../includes/header.php";
?>

<main class="millets-page">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 w-full">
      ...
      <div class="max-w-xl mb-6 md:mb-8 mt-2 md:mt-0">
        ...
        <p class="text-white/90 text-sm md:text-base">
          Premium Indian millets sourced directly from farms.
        </p>
      </div>
